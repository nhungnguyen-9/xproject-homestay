...
export function RoomCard({ title, price, images }: RoomCardProps) {
  // Lấy ảnh từ mảng (sử dụng fallback nếu mảng không đủ 5 ảnh)
