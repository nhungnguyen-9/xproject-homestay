...
export function RoomDetailPage({ suite, locationName }: RoomDetailPageProps) {
  ...
  const bookings = useMemo<Booking[]>(
    () => [
      { id: "b1", roomId: "g01", startTime: "01:45", endTime: "09:28", status: "confirmed" },
      { id: "b2", roomId: "g01", startTime: "09:58", endTime: "12:15", status: "confirmed" },
      { id: "b3", roomId: "g01", startTime: "13:15", endTime: "17:00", status: "confirmed" },
      { id: "b4", roomId: "g01", startTime: "18:30", endTime: "20:45", status: "confirmed" },
      { id: "b5", roomId: "p102", startTime: "01:45", endTime: "09:15", status: "confirmed" },
      { id: "b6", roomId: "p102", startTime: "10:45", endTime: "14:20", status: "confirmed" },
      { id: "b7", roomId: "p102", startTime: "15:30", endTime: "19:30", status: "confirmed" },
      { id: "b8", roomId: "p102", startTime: "19:00", endTime: "21:12", status: "confirmed" },
      { id: "b9", roomId: "p103", startTime: "00:45", endTime: "10:04", status: "confirmed" },
      { id: "b10", roomId: "p103", startTime: "10:34", endTime: "13:45", status: "confirmed" },
      { id: "b11", roomId: "p103", startTime: "13:15", endTime: "16:15", status: "confirmed" },
      { id: "b12", roomId: "p103", startTime: "16:35", endTime: "20:15", status: "confirmed" },
    ],
    []
  )
